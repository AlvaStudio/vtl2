...
* Update manpages, see [gen-manpages.sh](https://github.com/vitalium-project/vitalium/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [vitalium-detached-sigs](https://github.com/vitalium-project/vitalium-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the vitalium.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the vitalium.org server.

```

- Update vitalium.org version

- Announce the release:

  - vitalium-dev and vitalium-dev mailing list

  - blog.vitalium.org blog post
  ...
  - Create a [new GitHub release](https://github.com/vitalium-project/vitalium/releases/new) with a link to the archived release notes.
