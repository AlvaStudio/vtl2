...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 2335
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 12337
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 12357
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 12443
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 12444
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 2335
	%{_sbindir}/semanage port -d -p tcp 12337
	%{_sbindir}/semanage port -d -p tcp 12357
	%{_sbindir}/semanage port -d -p tcp 12443
