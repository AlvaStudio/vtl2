...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vitalium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vitalium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vitalium transaction") + "\n" +
              "  vitalium-tx [options] -create [commands]   " + _("Create hex-encoded vitalium transaction") + "\n" +
              "\n";
