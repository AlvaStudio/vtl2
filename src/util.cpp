...
const char * const BITCOIN_CONF_FILENAME = "vitalium.conf";
const char * const BITCOIN_PID_FILENAME = "vitaliumd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vitalium";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Vitalium";
#else
    // Unix
    return pathRet / ".vitalium";
#endif
#endif
}
